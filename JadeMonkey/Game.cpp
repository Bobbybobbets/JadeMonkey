...
Game::Game(HINSTANCE hInstance, char * gameName) : 
  mFullScreen(0), 
  mWndWidth(0), 
  mWndHeight(0),
  nearPlane(0), 
...
*/
int Game::getWndHeight(void)
{
	return (this->mWndHeight);
}

IDirect3DDevice9* Game::getGraphicsDevice(void)
{
	return this->md3dDev;
}
...
D3DMATRIX * Game::getProjMat(D3DXMATRIX * matProj)
{
